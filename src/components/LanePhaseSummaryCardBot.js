    ...
    return (
        <div id='laningBotAnchor'>
                ...
                <Grid item style={{ display: 'inline-flex', justifyContent: 'center' }} xs={12} sm={6}>
                    <Tooltip arrow placement='top' slotProps={{ popper: { modifiers: [{ name: 'offset', options: { offset: [0, -20] } }] } }} title={`${statsAt15.laneResults.BOTTOM.laneWinner[0]?.riotIdGameName} #${statsAt15.laneResults.BOTTOM.laneWinner[0]?.riotIdTagline}`}>
                        <div style={{ position: 'relative', display: 'inline-block' }}>
                            <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${statsAt15.laneResults.BOTTOM.laneWinner[0]?.riotIdGameName}/${statsAt15.laneResults.BOTTOM.laneWinner[0]?.riotIdTagline.toLowerCase()}`}><img alt='Champion' style={{ border: statsAt15.laneResults.BOTTOM.laneWinner[0].teamId === 100 ? '4px #568CFF solid' : '4px #FF3A54 solid', marginRight: '2px', filter: 'drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))' }} className='lanePhaseChampImgBotLarge' src={championImg(props.dataDragonVersion, winnerChampName1)}></img></a>
                        </div>
                    </Tooltip>
                    <Tooltip arrow placement='top' slotProps={{ popper: { modifiers: [{ name: 'offset', options: { offset: [0, -20] } }] } }} title={`${statsAt15.laneResults.BOTTOM.laneWinner[1]?.riotIdGameName} #${statsAt15.laneResults.BOTTOM.laneWinner[1]?.riotIdTagline}`}>
                        <div style={{ position: 'relative', display: 'inline-block' }}>
                            <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${statsAt15.laneResults.BOTTOM.laneWinner[1]?.riotIdGameName}/${statsAt15.laneResults.BOTTOM.laneWinner[1]?.riotIdTagline.toLowerCase()}`}><img alt='Champion' style={{ border: statsAt15.laneResults.BOTTOM.laneWinner[1].teamId === 100 ? '4px #568CFF solid' : '4px #FF3A54 solid', filter: 'drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))' }} className='lanePhaseChampImgBotLarge' src={championImg(props.dataDragonVersion, winnerChampName2)}></img></a>
                        </div>
                    </Tooltip>
                    ...
                    <Tooltip arrow placement='top' slotProps={{ popper: { modifiers: [{ name: 'offset', options: { offset: [0, -20] } }] } }} title={`${statsAt15.laneResults.BOTTOM.laneLoser[0]?.riotIdGameName} #${statsAt15.laneResults.BOTTOM.laneLoser[0]?.riotIdTagline}`}>
                        <div style={{ position: 'relative', display: 'inline-block' }}>
                            <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${statsAt15.laneResults.BOTTOM.laneLoser[0]?.riotIdGameName}/${statsAt15.laneResults.BOTTOM.laneLoser[0]?.riotIdTagline.toLowerCase()}`}><img alt='Champion' style={{ border: statsAt15.laneResults.BOTTOM.laneLoser[0].teamId === 100 ? '4px #568CFF solid' : '4px #FF3A54 solid', marginRight: '2px', filter: 'drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))' }} className='lanePhaseChampImgBotLarge' src={championImg(props.dataDragonVersion, loserChampName1)}></img></a>
                        </div>
                    </Tooltip>
                    <Tooltip arrow placement='top' slotProps={{ popper: { modifiers: [{ name: 'offset', options: { offset: [0, -20] } }] } }} title={`${statsAt15.laneResults.BOTTOM.laneLoser[1]?.riotIdGameName} #${statsAt15.laneResults.BOTTOM.laneLoser[1]?.riotIdTagline}`}>
                        <div style={{ position: 'relative', display: 'inline-block' }}>
                            <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${statsAt15.laneResults.BOTTOM.laneLoser[1]?.riotIdGameName}/${statsAt15.laneResults.BOTTOM.laneLoser[1]?.riotIdTagline.toLowerCase()}`}><img alt='Champion' style={{ border: statsAt15.laneResults.BOTTOM.laneLoser[1].teamId === 100 ? '4px #568CFF solid' : '4px #FF3A54 solid', filter: 'drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))' }} className='lanePhaseChampImgBotLarge' src={championImg(props.dataDragonVersion, loserChampName2)}></img></a>
                        </div>
                    </Tooltip>
                            ...
                            if (kill.victimId !== 0 && kill.killerId !== 0) {
                                return (
                                    <Typography key={`kill_${index}`}>{Math.round(kill.timestamp / 60000)}m - <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${participants.find(player => player.participantId === kill.killerId)?.riotIdGameName}/${participants.find(player => player.participantId === kill.killerId)?.riotIdTagline.toLowerCase()}`} style={{ color: participants.find(player => player.participantId === kill.killerId).teamId === 100 ? '#0089D6' : '#FF1616', fontWeight: 'bold' }}>{participants.find(player => player.participantId === kill.killerId)?.riotIdGameName}</a><img alt='Killer' style={{ maxWidth: '20px', maxHeight: '20px', marginLeft: '5px' }}
                                        src={championImg(props.dataDragonVersion, Object.values(champsJSON.data).find(champ => champ.key === String(participants.find(player => player.participantId === kill.killerId).championId)).id)}></img> killed <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${participants.find(player => player.participantId === kill.victimId)?.riotIdGameName}/${participants.find(player => player.participantId === kill.victimId)?.riotIdTagline.toLowerCase()}`} style={{ color: participants.find(player => player.participantId === kill.victimId).teamId === 100 ? '#0089D6' : '#FF1616', fontWeight: 'bold' }}>{participants.find(player => player.participantId === kill.victimId)?.riotIdGameName}</a><img alt='Victim' style={{ maxWidth: '20px', maxHeight: '20px', marginLeft: '5px' }} src={championImg(props.dataDragonVersion, Object.values(champsJSON.data).find(champ => champ.key === String(participants.find(player => player.participantId === kill.victimId).championId)).id)}></img></Typography>
                                )
                            }
                            if (kill.victimId === 0) {
                                return (
            ...
            <Grid className={lastButtonPressedBot === 'laneSumBot3' ? 'LanePhaseSummaryDetailsActive' : 'LanePhaseSummaryDetailsInActive'} style={{ flexDirection: 'row', display: 'flex' }}>
                <Grid item xs={12}>
                    <p style={{ marginBottom: '15px' }}>
                        Graph of CS killed each minute by <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${statsAt15.laneResults.BOTTOM.laneWinner[0]?.riotIdGameName}/${statsAt15.laneResults.BOTTOM.laneWinner[0]?.riotIdTagline.toLowerCase()}`} style={{ color: statsAt15.laneResults.BOTTOM.laneWinner[0].teamId === 100 ? '#0089D6' : '#FF1616', fontWeight: 'bold' }}> {statsAt15.laneResults.BOTTOM.laneWinner[0]?.riotIdGameName}</a><img alt='Champion' style={{ maxWidth: '20px', maxHeight: '20px', marginLeft: '5px', marginRight: '5px' }} src={championImg(props.dataDragonVersion, winnerChampName1)}></img>({statsAt15.laneResults.BOTTOM.laneWinner[0].kdaAlt}, {statsAt15.laneResults.BOTTOM.laneWinner[0].cs} CS), <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${statsAt15.laneResults.BOTTOM.laneWinner[1]?.riotIdGameName}/${statsAt15.laneResults.BOTTOM.laneWinner[1]?.riotIdTagline.toLowerCase()}`} style={{ color: statsAt15.laneResults.BOTTOM.laneWinner[1].teamId === 100 ? '#0089D6' : '#FF1616', fontWeight: 'bold' }}> {statsAt15.laneResults.BOTTOM.laneWinner[1]?.riotIdGameName}</a><img alt='Champion' style={{ maxWidth: '20px', maxHeight: '20px', marginLeft: '5px', marginRight: '5px' }} src={championImg(props.dataDragonVersion, winnerChampName2)}></img> ({statsAt15.laneResults.BOTTOM.laneWinner[1].kdaAlt}, {statsAt15.laneResults.BOTTOM.laneWinner[1].cs} CS), <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${statsAt15.laneResults.BOTTOM.laneLoser[0]?.riotIdGameName}/${statsAt15.laneResults.BOTTOM.laneLoser[0]?.riotIdTagline.toLowerCase()}`} style={{ color: statsAt15.laneResults.BOTTOM.laneLoser[0].teamId === 100 ? '#0089D6' : '#FF1616', fontWeight: 'bold' }}> {statsAt15.laneResults.BOTTOM.laneLoser[0]?.riotIdGameName}</a><img alt='Champion' style={{ maxWidth: '20px', maxHeight: '20px', marginLeft: '5px', marginRight: '5px' }} src={championImg(props.dataDragonVersion, loserChampName1)}></img> ({statsAt15.laneResults.BOTTOM.laneLoser[0].kdaAlt}, {statsAt15.laneResults.BOTTOM.laneLoser[0].cs} CS) and <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${statsAt15.laneResults.BOTTOM.laneLoser[1]?.riotIdGameName}/${statsAt15.laneResults.BOTTOM.laneLoser[1]?.riotIdTagline.toLowerCase()}`} style={{ color: statsAt15.laneResults.BOTTOM.laneLoser[1].teamId === 100 ? '#0089D6' : '#FF1616', fontWeight: 'bold' }}> {statsAt15.laneResults.BOTTOM.laneLoser[1]?.riotIdGameName}</a><img alt='Champion' style={{ maxWidth: '20px', maxHeight: '20px', marginLeft: '5px', marginRight: '5px' }} src={championImg(props.dataDragonVersion, loserChampName2)}></img>({statsAt15.laneResults.BOTTOM.laneLoser[1].kdaAlt}, {statsAt15.laneResults.BOTTOM.laneLoser[1].cs} CS) during laning phase.
                    </p>
