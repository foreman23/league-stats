...
const generateShortSummary = async (gameData, playerData, timelineData, stats15, dataDragonVersion, champsJSON) => {
    ...
    if (playerData.teamPosition === 'TOP') {
        ...
        if (lanes.TOP.laneWinner.riotIdGameName === playerData.riotIdGameName) {
            matchSummaryText = (<>In laning phase, <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${playerData.riotIdGameName}/${playerData.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{playerData.riotIdGameName} ({playerChampionName})</a> <LaneMatchupTooltip role="TOP" label={topDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningTopAnchor')} /> against <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${lanes.TOP.laneLoser.riotIdGameName}/${lanes.TOP.laneLoser.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{lanes.TOP.laneLoser.riotIdGameName} ({oppLoseChampionName})</a> while their team <LaneMatchupTooltip role="JUNGLE" label={jgDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningJgAnchor')} />, <LaneMatchupTooltip role="MIDDLE" label={midDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningMidAnchor')} />, and <LaneMatchupTooltip role="BOTTOM" label={botDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningBotAnchor')} />.</>)
        } else {
            matchSummaryText = (<>In laning phase, <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${playerData.riotIdGameName}/${playerData.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{playerData.riotIdGameName} ({playerChampionName})</a> <LaneMatchupTooltip role="TOP" label={topDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningTopAnchor')} /> against <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${lanes.TOP.laneWinner.riotIdGameName}/${lanes.TOP.laneWinner.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{lanes.TOP.laneWinner.riotIdGameName} ({oppWinChampionName})</a> while their team <LaneMatchupTooltip role="JUNGLE" label={jgDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningJgAnchor')} />, <LaneMatchupTooltip role="MIDDLE" label={midDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningMidAnchor')} />, and <LaneMatchupTooltip role="BOTTOM" label={botDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningBotAnchor')} />.</>)
        }
    }
    if (playerData.teamPosition === 'JUNGLE') {
        ...
        if (lanes.JUNGLE.laneWinner.riotIdGameName === playerData.riotIdGameName) {
            matchSummaryText = (<>In laning phase, <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${playerData.riotIdGameName}/${playerData.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{playerData.riotIdGameName} ({playerChampionName})</a> <LaneMatchupTooltip role="JUNGLE" label={jgDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningJgAnchor')} /> against <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${lanes.JUNGLE.laneLoser.riotIdGameName}/${lanes.JUNGLE.laneLoser.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{lanes.JUNGLE.laneLoser.riotIdGameName} ({oppLoseChampionName})</a> while their team <LaneMatchupTooltip role="TOP" label={topDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningTopAnchor')} />, <LaneMatchupTooltip role="MIDDLE" label={midDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningMidAnchor')} />, and <LaneMatchupTooltip role="BOTTOM" label={botDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningBotAnchor')} />.</>)
        } else {
            matchSummaryText = (<>In laning phase, <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${playerData.riotIdGameName}/${playerData.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{playerData.riotIdGameName} ({playerChampionName})</a> <LaneMatchupTooltip role="JUNGLE" label={jgDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningJgAnchor')} /> against <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${lanes.JUNGLE.laneWinner.riotIdGameName}/${lanes.JUNGLE.laneWinner.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{lanes.JUNGLE.laneWinner.riotIdGameName} ({oppWinChampionName})</a> while their team <LaneMatchupTooltip role="TOP" label={topDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningTopAnchor')} />, <LaneMatchupTooltip role="MIDDLE" label={midDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningMidAnchor')} />, and <LaneMatchupTooltip role="BOTTOM" label={botDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningBotAnchor')} />.</>)
        }
    }
    if (playerData.teamPosition === 'MIDDLE') {
        ...
        if (lanes.MIDDLE.laneWinner.riotIdGameName === playerData.riotIdGameName) {
            matchSummaryText = (<>In laning phase, <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${playerData.riotIdGameName}/${playerData.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{playerData.riotIdGameName} ({playerChampionName})</a> <LaneMatchupTooltip role="MIDDLE" label={midDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningMidAnchor')} /> against <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${lanes.MIDDLE.laneLoser.riotIdGameName}/${lanes.MIDDLE.laneLoser.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{lanes.MIDDLE.laneLoser.riotIdGameName} ({oppLoseChampionName})</a> while their team <LaneMatchupTooltip role="TOP" label={topDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningTopAnchor')} />, <LaneMatchupTooltip role="JUNGLE" label={jgDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningJgAnchor')} />, and <LaneMatchupTooltip role="BOTTOM" label={botDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningBotAnchor')} />.</>)
        }
        // Player lost lane
        else {
            matchSummaryText = (<>In laning phase, <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${playerData.riotIdGameName}/${playerData.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{playerData.riotIdGameName} ({playerChampionName})</a> <LaneMatchupTooltip role="MIDDLE" label={midDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningMidAnchor')} /> against <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${lanes.MIDDLE.laneWinner.riotIdGameName}/${lanes.MIDDLE.laneWinner.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink">{lanes.MIDDLE.laneWinner.riotIdGameName} ({oppWinChampionName})</a> while their team <LaneMatchupTooltip role="TOP" label={topDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningTopAnchor')} />, <LaneMatchupTooltip role="JUNGLE" label={jgDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningJgAnchor')} />, and <LaneMatchupTooltip role="BOTTOM" label={botDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningBotAnchor')} />.</>)
        }
    }
        ...
        if (playerData.teamPosition === 'BOTTOM') {
            ...
            if (lanes.BOTTOM.laneWinner.some(player => player.riotIdGameName === playerData.riotIdGameName)) {
                ...
                and <a href={`/profile/${gameData.info.platformId.toLowerCase()}/${utilityOpponent.riotIdGameName}/${utilityOpponent.riotIdTagline.toLowerCase()}`} className="matchSummaryPlayerLink"> {utilityOpponent.riotIdGameName} ({utilityOpponentChampionName})</a> while their team <LaneMatchupTooltip role="TOP" label={topDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningTopAnchor')} />, <LaneMatchupTooltip role="JUNGLE" label={jgDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningJgAnchor')} />, and <LaneMatchupTooltip role="MIDDLE" label={midDescEndGame} lanes={lanes} gameData={gameData} champsJSON={champsJSON} dataDragonVersion={dataDragonVersion} onClick={() => scrollToSection('laningMidAnchor')} />.</>);
            }
            // Player lost lane 
            else {
                playerChampionName = Object.values(champsJSON.data).find(champ => champ.key === String(playerData.championId)).name
