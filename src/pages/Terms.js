...
const Terms = () => {
  return (
    <div className='privacyPolicy'>
      ...
      <p>Welcome to <strong>RiftReport.gg</strong>. By accessing or using our website, you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, please do not use our website.</p>
      ...
      <p><strong>RiftReport.gg</strong> is provided on an "as-is" basis. We do not guarantee accuracy, availability, or reliability of the data. To the fullest extent permitted by law, we disclaim liability for any damages resulting from the use of our website.</p>

      <h2>6. Modifications to Terms</h2>
      <p>We may update these Terms and Conditions from time to time. Any changes will be posted on this page with an updated effective date.</p>
